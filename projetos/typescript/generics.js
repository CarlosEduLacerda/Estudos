...
const getFirstValueFromStringArray = getFirstValueFromArray(["1", "2"]);
const getFirstValueFromNumberArray = getFirstValueFromArray([1, 2]);
// Promises
...
const myGenericNumber1 = new GenericNumber(0, (x, y) => {
    return x + y;
});
